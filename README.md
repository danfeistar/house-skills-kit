...
| 身份 | Skill | 状态 |
|---|---|---|
| 全身份通用 | `calc-toolkit` 公共计算工具包 | ✅ 已发布（6 件工具，20 件锁版清单持续扩充） |
...
本仓库的业务模块（判客规则 / 佣金政策 / 案场话术 / 验房清单…）全部来自一线业务实践和企业规范化工作场景，不是工程师想象出来的 prompt。

> 交流合作：[GitHub 主页](https://github.com/danfeistar) · 欢迎 Issue 留言
